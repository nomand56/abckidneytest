...
import "./sliderwater.css";

export default function SliderHandling({ desc, solutions, solutionfn, message, onScoreUpdate }){
  ...
  <div className="slidercontentdiv">
    ...
    <div className="middlepng">
      <svg className="svgdiv " viewBox="0 0 175 500">
        <rect y={"0%"} fill="#836740" width="100%" height="100%" className="h-96 " />
        <rect
          y={100 - values[1] + "%"}
          fill="#2281cd"
          width="100%"
    ...
    <img src="/svgslider6.png" className="personimg svgslider6" />
