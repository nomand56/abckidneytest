...
const questions = [
    { text: 'Proximal convoluted tubule (PCT)', answers: ['Site of ~65% of all sodium reabsorption', 'Electrochemical gradient results in co-transport of sodium with solutes like PO4, glucose, amino acids', 'Site of sodium-hydrogen exchange channel (NHE3)', 'Acetazolamide site of action', 'Passive and active reabsorption of sodium'] },
    { text: 'Distal convoluted tubule (DCT)', answers: ['Site of epithelial sodium channel (ENac)', 'Thiazide site of action'] },
    { text: 'Thick ascending loop of Henle(TAHL)', answers: ['Site of sodium/potassium/2 chloride transporter (NKCC2)', 'Loop diuretic site of action'] },
    { text: 'Cortical collecting & connecting duct (CCD)', answers: ['Mineralocorticoid receptor antagonist site of action', 'Aldosterone sensitive segment of nephron', 'ADH sensitive segment of nephron'] },
];

const SodiumResobration = () => {
    ...
    const getInputPosition = (questionIndex) => {
        ...
        switch (position) {
            case 0: // Top Left
                return 'top-0 left-6 max-lg:left-0';
            case 1: // Top Right
                return '-top-10 max-lg:top-1 right-0';
            case 2: // Bottom Left
                return 'bottom-20 left-6 max-lg:left-0 max-lg:bottom-1 ';
            case 3: // Bottom Right
                return 'bottom-52 right-16  max-lg:right-0 max-lg:bottom-0';
            default:
                return '';
        }
    };
    const getDivPostions = (questionIndex) => {
        ...
        switch (position) {
            case 0: // Top Left
                return 'top-28 -left-6';
            case 1: // Top Right
                return 'top-20  right-6';
            case 2: // Bottom Left
                return 'top-1/2 left-6';
            case 3: // Bottom Right
            ...
            {quizCompleted ? (
                ...
                <>
                    <div className="grid grid-rows-[auto, auto, auto] gap-4 lg:mb-4  align-middle justify-center">
                        <div className="row-span-1  mb-10  question-card bg-gradient-to-r from-blue-300 to-blue-500 text-white p-6 shadow-md rounded-md align-middle justify-center">
                            <p className="text-lg align-middle justify-center">Drag and drop the specific salt handling mechanism to the correct segment of the nephron
</p>
                        </div>
                    </div>
                    <div className="relative ">
                        ...
                        />
                        <div className={`absolute max-lg:relative flex flex-col bg-green-200 px-2 py-2 justify-center items-center ${getInputPosition(activeQuestion)}`}>
                                ...
                                <div key={index} className="mt-2">
                                    <input
                                        ...
                                        className={`p-2 font-bold ${
                                            feedback === 'Correct!' ? 'bg-green-200 rounded-lg border-2' : feedback === 'Incorrect!' ? 'bg-red-200' : ''
                                            }`}
...
export default SodiumResobration;
