...
const questions = [
  { text: 'Proximal convoluted tubule (PCT)', answers: ['Carbonic anhydrase inhibitor  '] },
  { text: 'Distal convoluted tubule (DCT)', answers: ['Inhibits sodium chloride cotransporter (NCC)'] },
  { text: 'Thick ascending loop of Henle(TAHL)', answers: ['Inhibit sodium/potassium 2 chloride transporter (NKCC2)  '] },
  { text: 'Cortical collecting & connecting duct (CCD)', answers: ['Mineralocorticoid receptor antagonist  '] },
  { text: 'Amiloride & triamterene  ', answers: ['Inhibits epithelial sodium channel (Enac)  '] },
...
const handleNextQuestion = () => {
  ...
  const getDivPostions = (questionIndex) => {
    ...
    switch (position) {
      case 0: // Top Left
        return 'top-2/3 left-96';
      case 1: // Top Right
        return 'top-1/2  right-16';
      case 2: // Bottom Left
        return '-bottom-16 left-96';
      case 3: // Bottom Right
        return 'bottom-4 right-16 ';
      default:
        return '';
    }
  };
  ...
  const getInputPosition = (questionIndex) => {
    const position = questionIndex % 5;
    switch (position) {
      case 0: // Top Left
      ...
      case 2: // Bottom Left
        return 'bottom-28 left-10';
      case 3: // Bottom Right
        return 'bottom-28 right-32 ';
        case 4: // Bottom Right
        return ' bottom-1/2 right-28';
      default:
        return '';
    }
  };
